...
ExportQueueItem.scrapeExportPages = async (lock) => {
  return new Promise((resolve, reject) => {
    var baseUrl = 'https://nextapp.cz/export/overview?exportListFilter[export_branch][value]=0&exportListFilter[export_team][value]=0&exportListFilter[export_broker][value]=0&exportListFilter[export_request][values][]=10&exportListFilter[export_request][values][]=15&exportListFilter[export_result][values][]=0&exportListFilter[export_result][values][]=10&exportListFilter[export_result][values][]=20&exportListFilter[export_advert_status][values][]=20&exportListFilter[export_type][values][]=550&exportListFilter[export_type][values][]=50&exportListFilter[export_type][values][]=120&exportListFilter[export_type][values][]=255&exportListFilter[export_type][values][]=620&exportListFilter[export_type][values][]=30&exportListFilter[export_type][values][]=110&exportListFilter[export_type][values][]=261&exportListFilter[export_type][values][]=1&exportListFilter[export_type][values][]=350&exportListFilter[export_type][values][]=570&exportListFilter[export_type][values][]=640&exportListFilter[export_type][values][]=560&exportListFilter[export_type][values][]=160&exportListFilter[export_type][values][]=280&exportListFilter[export_type][values][]=240&exportListFilter[export_type][values][]=270&exportListFilter[export_type][values][]=3002&exportListFilter[export_type][values][]=170&exportListFilter[export_type][values][]=150&exportListFilter[export_type][values][]=600&exportListFilter[export_type][values][]=250&exportListFilter[export_type][values][]=180&exportListFilter[export_type][values][]=10&exportListFilter[export_type][values][]=11&exportListFilter[export_type][values][]=220&exportListFilter[export_type][values][]=20&exportListFilter[export_type][values][]=580&exportListFilter[export_type][values][]=3001&exportListFilter[export_type][values][]=610&exportListFilter[export_type][values][]=400&filter_submit=Použít+filtr#';
